...
strategy0 <- function (row_r, row_y, row_g, row_b, decisions, turn = TRUE) {
  ...
  for (i in 1:45) {
    if (decisions$roll_color1[i] == 'skip') {
      ...
      gap_scores1[i] <- gsc(decisions$roll1[i] - row_r[1])
      position_scores1[i] <- psc(decisions$roll1[i] - 1)
      count_scores1[i] <- row_r[2] + 1
    }
    else if (decisions$roll_color1[i] == 'yellow') {
      gap_scores1[i] <- gsc(decisions$roll1[i] - row_y[1])
      position_scores1[i] <- psc(decisions$roll1[i] - 1)
      count_scores1[i] <- row_y[2] + 1
    }
    else if (decisions$roll_color1[i] == 'green') {
      gap_scores1[i] <- gsc(row_g[1] - decisions$roll1[i])
      position_scores1[i] <- psc(rpc(decisions$roll1[i]) - 1)
      count_scores1[i] <- row_g[2] + 1
    }
    else if (decisions$roll_color1[i] == 'blue') {
      gap_scores1[i] <- gsc(row_b[1] - decisions$roll1[i])
      position_scores1[i] <- psc(rpc(decisions$roll1[i]) - 1)
      count_scores1[i] <- row_b[2] + 1
    }

    if (decisions$roll_color2[i] == 'skip') {
      gap_scores2[i] <- skip_score
      position_scores2[i] <- skip_score
      count_scores2[i] <- skip_score
    }
    else if (decisions$roll_color2[i] == 'red') {
      if (decisions$roll_color1[i] == 'red') {
        gap_scores2[i] <- gsc(decisions$roll2[i] - decisions$roll1[i])
        position_scores2[i] <- psc(decisions$roll2[i] - 1)
        count_scores2[i] <- row_r[2] + 2
      }
      else {
        gap_scores2[i] <- gsc(decisions$roll2[i] - row_r[1])
        position_scores2[i] <- psc(decisions$roll2[i] - 1)
      ...
      if (decisions$roll_color1[i] == 'yellow') {
        gap_scores2[i] <- gsc(decisions$roll2[i] - decisions$roll1[i])
        position_scores2[i] <- psc(decisions$roll2[i] - 1)
        count_scores2[i] <- row_y[2] + 2
      }
      else {
        gap_scores2[i] <- gsc(decisions$roll2[i] - row_y[1])
        position_scores2[i] <- psc(decisions$roll2[i] - 1)
      ...
      if (decisions$roll_color1[i] == 'green') {
        gap_scores2[i] <- gsc(decisions$roll1[i] - decisions$roll2[i])
        position_scores2[i] <- psc(rpc(decisions$roll2[i]) - 1)
        count_scores2[i] <- row_g[2] + 2
      }
      else {
        gap_scores2[i] <- gsc(row_g[1] - decisions$roll2[i])
        position_scores2[i] <- psc(rpc(decisions$roll2[i]) - 1)
      ...
      if (decisions$roll_color1[i] == 'blue') {
        gap_scores2[i] <- gsc(decisions$roll1[i] - decisions$roll2[i])
        position_scores2[i] <- psc(rpc(decisions$roll2[i]) - 1)
        count_scores2[i] <- row_b[2] + 2
      }
      else {
        gap_scores2[i] <- gsc(row_b[1] - decisions$roll2[i])
        position_scores2[i] <- psc(rpc(decisions$roll2[i]) - 1)
    ...
    if (decisions$roll_color1[i] != 'skip') {
      if (!is.na(gap_scores1[i]) & (gap_scores1[i] <= 0 | gap_scores1[i] >= 11))
        gap_scores1[i] <- NA
      if (!is.na(position_scores1[i]) &
          ((position_scores1[i] <= 0 | position_scores1[i] >= 12) |
           (position_scores1[i] == 1 & count_scores1[i] < 6)))
        position_scores1[i] <- NA
      if (!is.na(count_scores1[i]) & (count_scores1[i] <= 0 | count_scores1[i] >= 12))
        count_scores1[i] <- NA
    }

    if (decisions$roll_color2[i] != 'skip') {
      if (!is.na(gap_scores2[i]) & (gap_scores2[i] <= 0 | gap_scores2[i] >= 11))
        gap_scores2[i] <- NA
      if (!is.na(position_scores2[i]) &
          ((position_scores2[i] <= 0 | position_scores2[i] >= 12) |
           (position_scores2[i] == 1 & count_scores2[i] < 6)))
        position_scores2[i] <- NA
      if (!is.na(count_scores2[i]) & (count_scores2[i] <= 0 | count_scores2[i] >= 12))
        count_scores2[i] <- NA
    }
  }
  ...
  position_scores <- (position_scores1 + position_scores2) * 10/11
  count_scores <- (count_scores1 + count_scores2) * 10/11
...
strategy1 <- function (row_r, row_y, row_g, row_b, decisions, priority_order = '123',
                       skip_score = 5.5, skip_adjustment = 0, weight = 1/200, penalty,
                       turn = TRUE) {
  ...
  for (i in 1:45) {
    if (decisions$roll_color1[i] == 'skip') {
      gap_scores1[i] <- skip_score
      position_scores1[i] <- skip_score * 11/10
      count_scores1[i] <- skip_score * 11/10
    }
    else if (decisions$roll_color1[i] == 'red') {
      gap_scores1[i] <- gsc(decisions$roll1[i] - row_r[1])
      position_scores1[i] <- psc(decisions$roll1[i] - 1)
    ...
    if (decisions$roll_color2[i] == 'skip') {
      gap_scores2[i] <- skip_score
      position_scores2[i] <- skip_score * 11/10
      count_scores2[i] <- skip_score * 11/10
    }
    else if (decisions$roll_color2[i] == 'red') {
      if (decisions$roll_color1[i] == 'red') {
        gap_scores2[i] <- gsc(decisions$roll2[i] - decisions$roll1[i])
  ...
  position_scores <- ((position_scores1 + position_scores2) * 10/11)
  count_scores <- ((count_scores1 + count_scores2) * 10/11)
  prob_scores <- ((abs(position_scores1 - 6) + 1) * (gap_scores1 + count_scores1) +
                    (abs(position_scores2 - 6) + 1) * (gap_scores2 + count_scores2)) * weight
...
strategy3 <- function (row_r, row_y, row_g, row_b, decisions, skip_score = 5.5, table, state,
  ...
  gap_score <- skip_score
  position_score <- skip_score
  count_score <- skip_score
  if (skip_score == 0) {
    gap_score <- 0.5
    position_score <- 0.5
    count_score <- 0.5
  ...
  for (i in 1:45) {
    if (decisions$roll_color1[i] == 'skip') {
      gap_scores1[i] <- gap_score
      position_scores1[i] <- position_score
      count_scores1[i] <- count_score
    }
    else if (decisions$roll_color1[i] == 'red') {
      gap_scores1[i] <- gsc(decisions$roll1[i] - row_r[1])
      position_scores1[i] <- psc(decisions$roll1[i] - 1)
    ...
    if (decisions$roll_color2[i] == 'skip') {
      gap_scores2[i] <- gap_score
      position_scores2[i] <- position_score
      count_scores2[i] <- count_score
    }
    else if (decisions$roll_color2[i] == 'red') {
      if (decisions$roll_color1[i] == 'red') {
        gap_scores2[i] <- gsc(decisions$roll2[i] - decisions$roll1[i])
...
for (i in 1:n) {
  output <- single_player(1, skip_score = 5.5, weight = 0)
  scores <- append(scores, output[[1]])
  num_rolls <- append(num_rolls, output[[2]])
  row_r1 <- append(row_r1, output[[3]][1])
  row_r2 <- append(row_r2, output[[3]][2])
...
for (i in 1:n) {
  output <- single_player(2, move_option = 3)
  scores <- append(scores, output[[1]])
  num_rolls <- append(num_rolls, output[[2]])
  row_r1 <- append(row_r1, output[[3]][1])
  row_r2 <- append(row_r2, output[[3]][2])
...
for (i in 1:n) {
  score <- multiplayer(2, c(1, 1), c('123', '123'), c(5.5, 5.5), c(0, 0), c(1/200, 1/200),
                       c(NA, NA))
...
for (i in 1:n) {
  score <- multiplayer(2, c(1, 2), c('123', NA), c(5.5, NA), c(0, NA), c(1/200, NA), c(NA, 3))
  scores$winner[i] <- score[[1]]
  scores$p1_score[i] <- score[[2]][1]
  scores$p2_score[i] <- score[[2]][2]
  scores$num_rolls[i] <- score[[3]]
