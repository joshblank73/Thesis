...
2.  Only move to states that decrease number of rolls needed to lock a row based on 1 sum

3.  Only move to states that decrease number of rolls needed to lock a row based on 2 sums

4.  Only move to states that decrease number of rolls needed to lock a row based on 3 sums
